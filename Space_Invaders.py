...
def main():
    ...
    def redraw_window():
        ...
        if life_changed:
            lost_life = lost_font.render("You Lost a Life!!!", 1, WHITE)
            num_of_lives = lost_font.render(f"You have {lives} lives left.." if lives > 1 else f"You have {lives} life left..", 1, WHITE)
            WIN.blit(lost_life, (WIDTH/2 - lost_life.get_width()/2, 320))
            WIN.blit(num_of_lives, (WIDTH/2 - num_of_lives.get_width()/2, 380))
